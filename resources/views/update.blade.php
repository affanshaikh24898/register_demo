...
<div class="container">
  ...
  <a class="btn btn-success" href="/dashboard"> home</a>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{Auth::user()->username}}'s Profile</div>
                   ...
                   @endif
                    ...
                    @csrf
                       ...
                       <div class="form-group">
                           ...
                           <input type="date" class="form-control" id ="date_of_birth" name="date_of_birth" value="{{Auth::user()->date_of_birth}}"  max="<?php echo date("Y-m-d"); ?>">
                       </div>
                       <div class="form-group">
